...
export default defineConfig({
  base: "./",
  plugins: [firstAidBlocksPlugin(), noteStickersPlugin(), sidebarCollapseFixPlugin(), thumbnailVirtualizationPlugin(), workspaceSuspensionPlugin(), incrementalLibraryPersistencePlugin(), react(), bundlePdfAssets("dist-electron")],
  build: {
