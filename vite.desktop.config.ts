...
export default defineConfig({
  base: "./",
  plugins: [firstAidBlocksPlugin(), thumbnailVirtualizationPlugin(), workspaceSuspensionPlugin(), incrementalLibraryPersistencePlugin(), react(), bundlePdfAssets("dist-electron")],
  build: {
