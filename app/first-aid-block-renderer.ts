...
function blockStaticHtml(block: FirstAidBlock) {
  ...
  const content = "font-family:'Mali',cursive;font-size:12px;line-height:1.32;color:var(--fa-ink,#26343a);";
