...
const NAV_SELECTOR = ":scope > .note-thumbnails > .onenote-note-navigation";
...
.workspace.${WORKSPACE_CLASS}:not(.workspace-mode-reader)>.note-thumbnails.onenote-navigation-active{order:initial!important;grid-column:auto!important;width:100%!important;min-width:0!important;max-width:none!important;height:100%!important;align-self:stretch!important;display:flex!important;flex-direction:column!important;overflow:hidden!important;padding:0!important;border-left:1px solid #d5d5d5!important;border-right:0!important;background:#fff!important;resize:none!important}
.workspace.${WORKSPACE_CLASS}.workspace-mode-reader>.note-thumbnails.onenote-navigation-active{display:none!important}
.workspace.${WORKSPACE_CLASS}>.note-thumbnails.onenote-navigation-active.onenote-navigation-collapsed{width:100%!important;min-width:0!important;max-width:none!important}
.workspace.${WORKSPACE_CLASS}>.note-thumbnails>.onenote-note-navigation{width:100%!important;min-width:0!important;max-width:none!important;height:100%!important}
...
function applyRightLayout() {
  ...
  for (const workspace of Array.from(document.querySelectorAll<HTMLElement>(".workspace"))) {
    ...
    const aside = workspace.querySelector<HTMLElement>(":scope > .note-thumbnails");
    if (!navigation || !aside) {
