...
export default defineConfig({
  base: "/mednote-reader/",
  plugins: [firstAidBlocksPlugin(), noteStickersPlugin(), sidebarCollapseFixPlugin(), thumbnailVirtualizationPlugin(), workspaceSuspensionPlugin(), incrementalLibraryPersistencePlugin(), react(), bundlePdfAssets("pages-dist")],
  server: {
    host: "0.0.0.0",
