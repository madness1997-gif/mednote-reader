function e(e,t,n,r){function i(e){return e instanceof n?e:new n(function(t){t(e)})}return new(n||=Promise)(function(n,a){function o(e){try{c(r.next(e))}catch(e){a(e)}}function s(e){try{c(r.throw(e))}catch(e){a(e)}}function c(e){e.done?n(e.value):i(e.value).then(o,s)}c((r=r.apply(e,t||[])).next())})}function t(e){return this instanceof t?(this.v=e,this):new t(e)}function n(e,n,r){if(!Symbol.asyncIterator)throw TypeError(`Symbol.asyncIterator is not defined.`);var i=r.apply(e,n||[]),a,o=[];return a=Object.create((typeof AsyncIterator==`function`?AsyncIterator:Object).prototype),c(`next`),c(`throw`),c(`return`,s),a[Symbol.asyncIterator]=function(){return this},a;function s(e){return function(t){return Promise.resolve(t).then(e,f)}}function c(e,t){i[e]&&(a[e]=function(t){return new Promise(function(n,r){o.push([e,t,n,r])>1||l(e,t)})},t&&(a[e]=t(a[e])))}function l(e,t){try{u(i[e](t))}catch(e){p(o[0][3],e)}}function u(e){e.value instanceof t?Promise.resolve(e.value.v).then(d,f):p(o[0][2],e)}function d(e){l(`next`,e)}function f(e){l(`throw`,e)}function p(e,t){e(t),o.shift(),o.length&&l(o[0][0],o[0][1])}}var r=class{constructor(e,t){this.nextId=1,this.pending=new Map,this.worker=e,this.objectUrl=t,this.worker.addEventListener(`message`,e=>{let t=e.data,n=this.pending.get(t.id);if(n)if(this.pending.delete(t.id),t.type===`ok`)n.resolve(t.value);else{let e=Error(t.message);t.stack&&(e.stack=t.stack),n.reject(e)}}),this.worker.addEventListener(`error`,e=>{let t=e.error instanceof Error?e.error:Error(e.message||`Worker error`);for(let[e,n]of this.pending)this.pending.delete(e),n.reject(t)})}call(e,t=[]){let n=this.nextId++,r=Object.assign({id:n},e);return new Promise((e,i)=>{this.pending.set(n,{resolve:e,reject:i}),this.worker.postMessage(r,t)})}terminate(){this.worker.terminate(),this.objectUrl&&URL.revokeObjectURL(this.objectUrl);for(let[e,t]of this.pending)this.pending.delete(e),t.reject(Error(`Worker terminated`))}},i=class{constructor(e,t,n){this.channel=e,this.handle=t,this.number=n}getText(){return this.channel.call({type:`page.getText`,page:this.handle})}getOriginalSize(){return this.channel.call({type:`page.getOriginalSize`,page:this.handle})}render(e={}){return this.channel.call({type:`page.render`,page:this.handle,options:e})}},a=class{constructor(e,t){this.channel=e,this.handle=t}getPageCount(){return this.channel.call({type:`doc.getPageCount`,doc:this.handle})}getPage(t){return e(this,void 0,void 0,function*(){let e=yield this.channel.call({type:`doc.getPage`,doc:this.handle,pageIndex:t});return new i(this.channel,e.page,e.pageIndex)})}pages(){return n(this,arguments,function*(){let e=yield t(this.getPageCount());for(let n=0;n<e;n++)yield yield t(yield t(this.getPage(n)))})}destroy(){return e(this,void 0,void 0,function*(){yield this.channel.call({type:`doc.destroy`,doc:this.handle})})}},o=class{constructor(e){this.channel=e}loadDocument(t,n){return e(this,void 0,void 0,function*(){let e=t.buffer instanceof ArrayBuffer?[t.buffer]:[],r=yield this.channel.call({type:`loadDocument`,bytes:t,password:n},e);return new a(this.channel,r.doc)})}destroy(){return e(this,void 0,void 0,function*(){try{yield this.channel.call({type:`destroy`})}finally{this.channel.terminate()}})}};function s(t){return e(this,void 0,void 0,function*(){let e=new Blob([t.workerSource],{type:`text/javascript`}),n=URL.createObjectURL(e),i=new r(new Worker(n,{type:`module`}),n),a=t.init.wasmBinary?[t.init.wasmBinary]:[];return yield i.call(Object.assign({type:`init`},t.init),a),i})}var c=class t extends o{static spawn(n){return e(this,void 0,void 0,function*(){if(!n||!n.wasmUrl&&!n.wasmBinary)throw Error(`PDFiumWorkerClient.spawn: wasmUrl or wasmBinary is required`);return new t(yield s({workerSource:`/******************************************************************************\r
...
***************************************************************************** */\r
/* global Reflect, Promise, SuppressedError, Symbol, Iterator */\r
\r
\r
...
\r
typeof SuppressedError === "function" ? SuppressedError : function (error, suppressed, message) {\r
    var e = new Error(message);\r
    return e.name = "SuppressedError", e.error = error, e.suppressed = suppressed, e;\r
};
...
`,init:{wasmUrl:n.wasmUrl,wasmBinary:n.wasmBinary}}))})}};export{c as PDFiumWorkerClient};